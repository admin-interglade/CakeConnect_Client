...
export const strings = {
  ...
  owners: {
    ...
    /* The owner directory, reached from the create form. */
    listAction: 'View all owners',
    listTitle: 'Shop owners',
    listSubtitle: 'Tap an owner to update their details.',
    searchPlaceholder: 'Search by name or mobile number',
    listEmpty: 'No shop owners yet.',
    listEmptySearch: 'No owner matches that search.',
    cardHint: 'Opens the owner form to update their details',
    editTitle: 'Update owner',
    editAction: 'Update owner',
    update: 'Save changes',
    ...
    fields: {
      ...
      addShops: 'Shops to add',
    },
    hints: {
      phone: 'This is the number they sign in with.',
      phoneEdit: 'Changing this changes the number they sign in with.',
      email:
        'A temporary password is emailed here. The owner sets their own on first login.',
      emailEdit: 'Account emails are sent to this address.',
      shops: 'Only shops that no owner holds yet are listed.',
      heldShops: (names: string[]) =>
        `Already holds ${names.join(', ')}. Only shops that no owner holds yet are listed.`,
    },
